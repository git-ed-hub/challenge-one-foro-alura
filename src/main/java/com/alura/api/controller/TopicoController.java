...
import com.alura.api.domain.respuesta.DatosListadoRespuestas;
...
public class TopicoController {
    ...
    @PostMapping
    @Transactional
    public ResponseEntity<DatosRegistroTopico> registraTopico(@RequestBody @Valid DatosRegistroTopico datosRegistroTopico,
